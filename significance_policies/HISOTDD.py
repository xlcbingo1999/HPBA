...
class HISOTDDPolicy(SigPolicy):
    ...
    def get_job_datablock_OTDD_sync(self, train_dataset_name, sub_train_key_id, test_dataset_name, sub_test_key_id):
    ...
    def get_job_datablock_significance_sync(self, job_id, signficance_state, is_history):
        ...
        if is_history:
            result_norm_d = self.get_job_datablock_OTDD_sync(train_dataset_name, sub_train_key_id, test_dataset_name, sub_test_key_id)
        else:
