...
todo_time = time.strftime('%Y-%m-%d-%H-%M-%S', time.localtime())
...
dataset_reconstruct_path = "schedule-review-testbed-06-18-12-28-24"
history_jobtrace_reconstruct_path = "schedule-review-testbed-06-18-12-28-24"
...
seeds = [1234, 2345, 3456, 6789, 7890] if simulation_flag else [3456]
...
his_adaptive_cons_generate_flag = "MinBlock" # None, Fair, MinBlock
...
if nohup_flag:
    nohup_worker_dir = os.path.join(nohup_target_dir_prefix, f"worker_{todo_time}_{target_time_minute}.log")
...
if nohup_flag:
    nohup_sched_dir = os.path.join(nohup_target_dir_prefix, f"sched_{todo_time}_{target_time_minute}.log")
...
if "HIS" in assignment_policy:
    ...
    dispatcher_cmds.append(f"--his_adaptive_cons_generate_flag {his_adaptive_cons_generate_flag}")
...
if nohup_flag:
    nohup_dispatcher_dir = os.path.join(nohup_target_dir_prefix, f"dispatcher_{todo_time}_{target_time_minute}.log")
